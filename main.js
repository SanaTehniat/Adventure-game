...
console.log(chalk.italic.yellowBright.bold.italic("     /$/$     |$|$$$$$$$  $          /$ |$|$$$$$  |$|$     |$| $$$$$$$$$ |$|     |$ |$|$$$$  |$|$$$$$    //$$$$$$$        /$/$      |$|$          /$|$|  |$|$$$$$"));
console.log(chalk.italic.greenBright.bold.italic("    /$/  $    |$|       $  $        /$/ |$|       |$| $    |$|   |$|     |$|     |$ |$|    ) |$|         ||       ||     /$/  $     |$| $        /$/|$|  |$|"));
console.log(chalk.italic.blueBright.bold.italic("   /$/    $   |$|        $  $      /$/  |$|$$$    |$|  $   |$|   |$|     |$|     |$ |$|$$$$  |$|$$$      ||             /$/    $    |$|  $      /$/ |$|  |$|$$$"));
console.log(chalk.italic.magentaBright.bold.italic("  /$/!!!!!!$  |$|        $   $    /$/   |$|$$$    |$|   $  |$|   |$|     |$|     |$ |$| $    |$|$$$      ||     $$     /$/!!!!!!$   |$|   $    /$/  |$|  |$|$$$"));
console.log(chalk.italic.redBright.bold.italic(" /$/        $ |$|       $     $  /$/    |$|       |$|    $ |$|   |$|     |$|     |$ |$|  $   |$|         ||       ||  /$/        $  |$|    $  /$/   |$|  |$|"));
console.log(chalk.italic.blueBright.bold.italic("/$/          $|$|$$$$$$$       $/$/     |$|$$$$$  |$|     $|$|   |$|        $$$$$    |$|   $ |$|$$$$$      $$$$$$//  /$/          $ |$|     $/$/    |$|  |$|$$$$$"));
console.log(chalk.italic.cyanBright.bold.italic("\n\t<#<#<#<#<WellCome TO Adventure Game>#>#>#>#>\t\n"));
class Player {
    name;
    fuel = 100;
    constructor(name) {
...
let p1 = new Player(player.name); // class ka object create krta hai (New)
let o1 = new Opponent(opponent.select);
// console.log(chalk.italic.greenBright.bold("Welcome" + p1.name + " to the game"))
do {
